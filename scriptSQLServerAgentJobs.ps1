...
#
#
# Example Execution: .\scriptSQLServerAgentJobs.ps1 .\ServerNameList.txt
...
$progress = $num.ToString() +' Jobs scripted out of total ' + $srv.JobServer.Jobs.Count.ToString()
$percentComplete = ($num / $srv.JobServer.Jobs.Count.ToString()) * 100

Write-Progress -Activity 'Scripting jobs on $ServerName' -Status "Scripting jobs ... $progress" -PercentComplete $percentComplete
